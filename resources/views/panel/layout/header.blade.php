        ...
        <div class="p-0 container-fluid max-lg:w-full">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{activeRoute('dashboard.search.index')}}"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{activeRoute('dashboard.user.vertical.name')}}"
                            href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                            aria-expanded="false">
                            <span class="nav-link-icon" style="stroke:unset">
                                <svg style="position:relative;left:2px;" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="dropdown-menu {{ activeRouteBulkShow(['dashboard.user.vertical.name']) }}">
							@php 
								$verticals = \App\Models\VerticalCategory::withCount('vertical')->orderBy('name', 'ASC')->get();
							@endphp
							@foreach( $verticals as $vertical )
								<a class="nav-link {{ route('dashboard.user.vertical.name' , $vertical->slug ) == url()->current() ? 'active' : '' }}" href="{{ route('dashboard.user.vertical.name', $vertical->slug ) }}">
									{{__( $vertical->name )}}
								</a>
							@endforeach
						</div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{activeRoute('dashboard.external-site')}}"
                            href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                            aria-expanded="false">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <div class="dropdown-menu {{activeRouteBulkShow(['dashboard.external-site'])}}">
                            <a class="nav-link {{ route('dashboard.external-site', 'plato-network') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','plato-network')}}">
                                {{__('Plato Network')}}
                            </a>
                            ...
                            <a class="nav-link {{ route('dashboard.external-site', 'plato-aistream') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','plato-aistream')}}">
                                {{__('Plato AiStream')}}
                            </a>



                            <a class="nav-link {{ route('dashboard.external-site', 'platodata-io') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','platodata-io')}}">
                                {{__('PlatoData IO')}}
                            </a>

                            <a class="nav-link {{ route('dashboard.external-site', 'plato-esg') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','plato-esg')}}">
                                {{__('Plato ESG')}}
                            </a>

                            <a class="nav-link {{ route('dashboard.external-site', 'plato-gaming') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','plato-gaming')}}">
                                {{__('Plato Gaming')}}
                            </a>

                            <a class="nav-link {{ route('dashboard.external-site', 'plato-health') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','plato-health')}}">
                                {{__('Plato Health')}}
                            </a>
                            ...
                            <a class="nav-link {{ route('dashboard.external-site', 'zephyrnet') == url()->current() ? 'active' : '' }}"
                                href="{{route('dashboard.external-site','zephyrnet')}}">
                                {{__('Zephyrnet')}}
                            </a>
					...
					<li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{activeRoute('dashboard.publication.externalSite')}}"
                            href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                            aria-expanded="false">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
						...
						<div class="dropdown-menu {{ activeRouteBulkShow(['dashboard.publication.externalSite']) }}">

						@foreach($publications as $publication)
								<a class="nav-link {{ request()->url() == route('dashboard.publication.externalSite', ['slug' => $publication->slug]) ? 'active' : '' }}"
								href="{{ route('dashboard.publication.externalSite', ['slug' => $publication->slug]) }}">
                    ...
                    @if ( $setting->feature_ai_puretalk )
                    <li class="nav-item">
                        <a class="nav-link {{ route('dashboard.user.puretalk.speech.show') == url()->current() ? 'active' : '' }}"
                            href="{{route('dashboard.user.puretalk.speech.show')}}">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
                                {{__('PureTalk AI')}} <span
                                    style="font-size: 9px;margin-left: 3px;margin-top: -10px;">TM</span>
                            </span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div
                            ...
                            <a class="nav-link {{activeRoute('dashboard.admin.openai.list')}}"
                                href="{{route('dashboard.admin.openai.list')}}">
                                {{__('Built-in Templates')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.openai.custom.list')}}"
                                href="{{route('dashboard.admin.openai.custom.list')}}">
                                {{__('Custom Templates')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.openai.categories.list')}}"
                                href="{{route('dashboard.admin.openai.categories.list')}}">
                                {{__('AI Writer Categories')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.openai.chat.list')}}"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div
                            ...
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.settings')}}"
                                href="{{route('dashboard.admin.frontend.settings')}}">
                                {{__('Frontend Settings')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.sectionsettings')}}"
                                href="{{route('dashboard.admin.frontend.sectionsettings')}}">
                                {{__('Frontend Section Settings')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.menusettings')}}"
                                href="{{route('dashboard.admin.frontend.menusettings')}}">
                                {{__('Menu')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.faq.index')}}"
                                href="{{route('dashboard.admin.frontend.faq.index')}}">
                                {{__('F.A.Q')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.tools.index')}}"
                                href="{{route('dashboard.admin.frontend.tools.index')}}">
                                {{__('Tools Section')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.future.index')}}"
                                href="{{route('dashboard.admin.frontend.future.index')}}">
                                {{__('Features Section')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.testimonials.index')}}"
                                href="{{route('dashboard.admin.testimonials.index')}}">
                                {{__('Testimonials Section')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.clients.index')}}"
                                href="{{route('dashboard.admin.clients.index')}}">
                                {{__('Clients Section')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.howitWorks.index')}}"
                                href="{{route('dashboard.admin.howitWorks.index')}}">
                                {{__('How it Works Section')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.whois.index')}}"
                                href="{{route('dashboard.admin.frontend.whois.index')}}">
                                {{__('Who Can Use Section')}}
                            </a>

                            <a class="nav-link {{activeRoute('dashboard.admin.frontend.generatorlist.index')}}"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div
                            ...
                            <a class="nav-link {{activeRoute('dashboard.admin.finance.plans.index')}}"
                                href="{{route('dashboard.admin.finance.plans.index')}}">
                                {{__('Membership Plans')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.finance.paymentGateways.index')}}"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle  {{activeRoute('dashboard.vertical.list')}}"
                            href="{{route('dashboard.vertical.list')}}" data-bs-toggle="dropdown"
                        ...
                        <div
                            class="dropdown-menu {{ activeRouteBulkShow( ['dashboard.vertical.list', 'dashboard.vertical.category.list'] ) }}">
                            <a class="dropdown-item {{activeRoute('dashboard.vertical.list')}}"
                                href="{{route('dashboard.vertical.list')}}">
                                {{__('Listing')}}
                            </a>
                            <a class="dropdown-item {{activeRoute('dashboard.vertical.category.list')}}"
                                href="{{route('dashboard.vertical.category.list')}}">
                                {{__('Category')}}
                            </a>
                            <a class="dropdown-item {{activeRoute('dashboard.vertical.crawl.list')}}"
                                href="{{route('dashboard.vertical.crawl.list')}}">
                                {{__('Crawl')}}
                            </a>
                        </div>
                    </li>
					...
					<li class="nav-item">
						<a class="nav-link {{activeRoute('dashboard.admin.publications.create')}}" href="{{route('dashboard.admin.publications.create')}}">
							<span class="nav-link-icon">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div
                            ...
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.general')}}"
                                href="{{route('dashboard.admin.settings.general')}}">
                                {{__('General')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.invoice')}}"
                            ...
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.openai')}}"
                                href="{{route('dashboard.admin.settings.openai')}}">
                                {{__('OpenAI')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.stablediffusion')}}"
                                href="{{route('dashboard.admin.settings.stablediffusion')}}">
                                {{__('StableDiffusion')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.unsplashapi')}}"
                                href="{{route('dashboard.admin.settings.unsplashapi')}}">
                                {{__('Unsplash API')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.tts')}}"
                                href="{{route('dashboard.admin.settings.tts')}}">
                                {{__('Google TTS')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.affiliate')}}"
                                href="{{route('dashboard.admin.settings.affiliate')}}">
                                {{__('Affiliate')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.smtp')}}"
                                href="{{route('dashboard.admin.settings.smtp')}}">
                                {{__('SMTP')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.gdpr')}}"
                                href="{{route('dashboard.admin.settings.gdpr')}}">
                                {{__('GDPR')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.privacy')}}"
                                href="{{route('dashboard.admin.settings.privacy')}}">
                                {{__('Privacy Policy and Terms')}}
                            </a>
                            <a class="nav-link {{activeRoute('amamarul.translations.home')}} {{activeRoute('amamarul.translations.lang')}}"
                                href="{{LaravelLocalization::localizeUrl( route('amamarul.translations.home') )}}">
                                {{__('Languages')}}
                            </a>
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.storage')}}"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ activeRouteBulk( ['dashboard.admin.sitemap.index', 'dashboard.admin.sitemap.links.index'] ) }}"
                            href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                            aria-expanded="false">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <line x1="4" y1="9" x2="9" y2="3" />
                                    <line x1="12" y1="9" x2="12" y2="3" />
                                    <line x1="20" y1="9" x2="15" y2="3" />
                        ...
                        <div
                            class="dropdown-menu {{ activeRouteBulkShow( ['dashboard.admin.sitemap.index', 'dashboard.admin.sitemap.links.index'] ) }}">
                            <a class="dropdown-item {{ activeRoute('dashboard.admin.sitemap.index')}}"
                                href="{{route('dashboard.admin.sitemap.index')}}">
                                {{__('General')}}
                            </a>
                            <a class="dropdown-item {{activeRoute('dashboard.admin.sitemap.links.index')}}"
                                href="{{route('dashboard.admin.sitemap.links.index')}}">
                                {{__('Add Links')}}
                            </a>
                        </div>
                    </li>
            ...
            <div class="flex gap-[18px] max-lg:gap-2">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
						<div class="flex flex-col language_dropdown">
						{{-- 
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
								@if(in_array( $localeCode, explode(',', $settings_two->languages) ))
									<a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="flex items-center px-3 py-2 border-solid border-[--tblr-border-color] border-t-0 border-r-0 border-l-0 last:border-b-0 text-heading transition-colors hover:no-underline hover:bg-[--tblr-border-color]">
										<span class="text-[21px] !me-2">{{ country2flag(substr($properties['regional'], strrpos($properties['regional'], '_') + 1)) }} </span>{{$properties['name']}}
									</a>
								@endif
                            @endforeach --}}
						</div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="nav-link {{activeRoute('dashboard.user.payment.subscription')}}"
                            href="{{route('dashboard.user.payment.subscription')}}">
                            {{__('Plan')}}
                        </a>
                        <a class="nav-link {{activeRoute('dashboard.user.orders.index')}}"
                            href="{{route('dashboard.user.orders.index')}}">
                            {{__('Orders')}}
                        </a>
                        <a class="nav-link {{activeRouteBulk(['dashboard.user.settings.index'])}}"
            ...
            <form
                ...
                <div class="w-full input-icon max-lg:p-3 max-lg:bg-[#fff] max-lg:dark:bg-zinc-800">
                    ...
                    <input type="search"
                        ...
                        placeholder="{{__('Plato search directory')}}" aria-label="Search in website">
                    <kbd
                    ...
                    <div class="navbar-search-results absolute top-[calc(100%+17px)] !start-0 bg-[#fff] shadow-[0_10px_70px_rgba(0,0,0,0.1)] rounded-md w-[100%] max-h-[800px] overflow-y-auto hidden group-[.done-searching]:block dark:!bg-[--tblr-bg-surface] max-lg:top-auto max-lg:bottom-full max-lg:start-0 max-lg:end-0 max-lg:w-auto"
