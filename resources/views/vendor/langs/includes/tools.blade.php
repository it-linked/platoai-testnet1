<div class="row">
   ...
   --}}
    ...
    <div class="col-md-6 mb-2">
        <form action="{{route('amamarul.translations.lang.setLocale')}}" class="relative" method="GET" onSubmit="if(!confirm('{{__('Are you sure you want to change default language?')}}')){return false;}">
